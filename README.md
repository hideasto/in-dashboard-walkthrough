...
**The clean dashboard, no walkthrough active:**

![Clean dashboard](walkthrough-screenshots/07-clean-dashboard-no-overlay.png)

**Welcome gate — first thing a new user sees, forces a yes/no choice:**

![Welcome gate](walkthrough-screenshots/00-welcome-prompt.png)

**Step 1 — Clear Slicers:**

![Step 1: Clear Slicers](walkthrough-screenshots/01-clear-slicers.png)

**Step 2 — All-Time or Region view toggle:**

![Step 2: All-Time or Region view](walkthrough-screenshots/02-alltime-or-region.png)

**Step 3 — Metric and Disaggregation selection:**

![Step 3: Metric and Disaggregation selection](walkthrough-screenshots/03-metric-and-disaggregation.png)

**Step 4 — Primary Table**, including its own independent Region/Route/Gym/Battle ID filter row (pink-tinted):

![Step 4: Primary Table](walkthrough-screenshots/04-primary-table.png)

**Step 5 — Comparison Table**, with its own separate filter row, independent from the Primary Table's:

![Step 5: Comparison Table](walkthrough-screenshots/05-comparison-table.png)

**Step 6 — Frequent Q&A**, pointing at the actual button in the header:

![Step 6: Frequent Q&A](walkthrough-screenshots/06-frequent-qa.png)

An interactive HTML mockup of the same pattern is included as `walkthrough-demo.html` — open it locally, or use the live preview link above, to click through Next/Back the way it behaves in the real dashboard. It's a stand-in for the concept, not an export of an actual Power BI file.
